...
const Menu = props => {
            ...
            menu => {
                ...
                return (
                        ...
                        className={
                            props.minimaze ?
                                activeMenu && activeMenu.id === menu.id ?
                                    `${classes.minimaze} ${classes.menuList} ${classes.menuListActive}`
                                    :
                                    `${classes.minimaze} ${classes.menuList}`
                                :
                                activeMenu && activeMenu.id === menu.id ?
                    ...
                    >
                        ...
                        <div className={props.minimaze ? `${classes.hiddenElem} ${classes.textElem}` : classes.textElem}>
                            <span>{menu.name}</span>
                        </div>
                    </div>
                )
    ...
    return (
        <div className={props.menu ? `${classes.openMenu} ${classes.menu}` : classes.menu}>
            <div>
                {
                    props.menus ?
