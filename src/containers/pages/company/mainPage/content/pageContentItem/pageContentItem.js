...
import cls from './pageContentItem.module.css';
import CustomButton from "../../../../../../components/buttons/myButton";

const PageContentItem = props => {

    return (
        <div className={cls.pageContentItem}>
            <div className={cls.rowContainerContent}>
                <div className={cls.imageWindow}>
                    <img src={props.url} alt={props.alt}/>
                </div>
                <div className={cls.rowContainerTextContent}>
                    <div>
                        <span className={cls.companyName}>
                            {props.name}
                        </span>
                    </div>
                    <div className={cls.otherContnet}>
                            <span className={cls.companyNumber}>
                                {props.hvhh}
                            </span>
                        <span className={cls.companyBank}>
                            {props.bank}
                        </span>
                    </div>
                </div>
