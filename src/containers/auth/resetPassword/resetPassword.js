...
import classes from "../forgotPassword/foegotPassword.module.css";
import {
    createNewPass,
    userInformation,
    progressAction,
    sendMailSuccess,
    sendMailError
} from '../../../redux/authResetPassword/actions'
                            ...
                            this.props.success ?
                                ...
                                <>
                                    <form onSubmit={event => this.onSubmit(event)}>
                                     ...
                                     ${this.state.isEmpty['password'] ? `${cls.error} ${cls.erroVerify}` : ''}
                                     `
                                            }
                                        >
...
function mapStateToProps(state) {
    return {
        ...
        signature: state.resetPass.signature,
        timestamp: state.resetPass.timestamp,
        user_id: state.resetPass.user_id,
    }
}
